...
const LoginContent: React.FC<LoginProps> = ({ onLogin }) => {
      ...
      <div className="auth-card figma-login-card">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          {recaptchaSiteKey && (
            <div className="form-group">
              <SafeReCAPTCHA
                ...
                onBoundaryError={(err) => {
                  console.error('User login reCAPTCHA error:', err);
          ...
          <div className="forgot-below">
            ...
            <Link className="forgot-link" to="/forgot-password" state={{ userType: 'user' }}>Forgot Password?</Link>
          </div>
        </form>
